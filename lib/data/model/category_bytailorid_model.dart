...
class CategoryBytailoridModel {
  Meta? meta;
  Data? data;

  CategoryBytailoridModel({this.meta, this.data});

  CategoryBytailoridModel.fromJson(Map<String, dynamic> json) {
...
class Data1 {
  ...
  Data1({this.itemId, this.itemName, this.itemPhoto});
