...
class TailorByitemidModel {
  Meta? meta;
  Data? data;

  TailorByitemidModel({this.meta, this.data});

  TailorByitemidModel.fromJson(Map<String, dynamic> json) {
...
class Data1 {
  ...
  String? kota;
  String? rating;
  dynamic jumlahTransaksi;

  Data1({this.taylorId, this.taylorName, this.photo, this.phone, this.kota, this.rating, this.jumlahTransaksi});
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["kota"] = kota;
    _data["rating"] = rating;
    _data["jumlah_transaksi"] = jumlahTransaksi;
    return _data;
  }
}
